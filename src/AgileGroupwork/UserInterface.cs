        ...
        public void Start()
        {
            while (true)
            {
                ...
                if (command == "1")
                {
                    ...
                    list.Add(new Score(name, score, type));
                    Console.WriteLine("Thank you! Added " + name + "'s " + score + " scores to the scorelist!");
                }
                if (command == "2")
                {
                    Console.WriteLine("Which person's score would you like to see");
                    string person = Console.ReadLine();
                    Console.WriteLine("Here are the scores for " + person);
                }
                if (command == "3")
                {
